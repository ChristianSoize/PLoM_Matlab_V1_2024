function [ind_step1,ind_step2,ind_step3,ind_step4,ind_step4_task13,ind_step4_task14,ind_step4_task15, ...
    ...
    %                 ind_workflow = 1 concerning Benchmark1_Direct_NoPartition_CondStat_pdf
    ...
    if ind_step4 == 1
       ...
       if ind_step4_task13 == 1
          ...
          MatRww0_obs  = [-21.4 -9.4  -7.1 -4.0 -11.3
                          -21.3 -10.8 -6.0 -1.7 -9.4];

                                 %--- For ind_pdf = 1:
          Ind_Qcomp = [3 4 35]'; % Ind_Qcomp(nbQcomp,1): pdf of Q_obs_kk | WW_obs = Rww0_obs in which Q_obs_kk = MatRqq_obs(k,:)
                                 ...
                                 % must belong to the set of components declared in mainWorkflow_Data_generation1.m in the array 
                                 % Indq_obs. In the example, it is assumed that n_q = 35 and Indq_obs = [1 2 3 4 35]'
