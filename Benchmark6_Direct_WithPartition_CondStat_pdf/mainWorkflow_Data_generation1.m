...
function [n_q,Indq_real,Indq_pos,n_w,Indw_real,Indw_pos,Indq_obs,Indw_obs,n_d,MatRxx_d] = mainWorkflow_Data_generation1
   ...
   %  Subject      : This function allows to generate data for Benchmark6_Direct_WithPartition_CondStat_pdf
   %
   %
   ...
   MatRqq_d = MatRxx_data(1:26,:);     % MatRqq_d(n_q,n_d)
   MatRww_d = MatRxx_data(27:28,:);    % MatRww_d(n_w,n_d)
   ...
   Indq_obs = [1 11 18 26]';  % nq_obs component numbers of QQ that are observed , 1 <= nq_obs <= n_q
