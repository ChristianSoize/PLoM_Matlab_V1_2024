...
function [ind_type_targ,Indq_targ_real,Indq_targ_pos,Indw_targ_real,Indw_targ_pos,N_r, ...
   ...
   load FileMatRxxTarget1 
        ...
        Indw_targ_real = [];                        % Indw_targ_real(nwreal_targ,1)
        Indw_targ_pos  = [1 2]';                    % Indw_targ_pos(nwpos_targ,1)
        ...
        MatRqq_targ_pos  = [];                                          % MatRqq_targ_pos(nqpos_targ,N_r)

        MatRww_targ_real = [];                                          % MatRww_targ_real(nwreal_targ,N_r)
        MatRww_targ_pos  = MatRww_target_data(:,1:N_r);                 % MatRww_targ_pos(nwpos_targ,N_r)

        %--- Loading MatRxx_targ_real and MatRxx_targ_pos
        MatRxx_targ_real = [MatRqq_targ_real                            % MatRxx_targ_real(nbreal_targ,N_r) 
                            MatRww_targ_real]; 

        MatRxx_targ_pos = [MatRqq_targ_pos                              % MatRxx_targ_pos(nbpos_targ,N_r)   
                           MatRww_targ_pos]; 
