function [MatRPsi0,MatPower0,MatRa0] = sub_polynomialChaosQWU_chaos0(K0,Ndeg,Ng,NnbMC0,MatRxiNg0)
   ...
   if Ndeg >= 1
      ...
      if indExecChol == 0
         ...
         error('STOP in sub_polynomialChaosQWU_chaos0: The matrix MatRFF must be positive definite');
      end
      MatRa0   = inv(MatRLL);                                 % MatRa(K0,K0) : sparse matrix
      MatRPsi0 = full(MatRa0*MatRMM);                         % MatRPsi0(K0,NnbMC0),MatRa0(K0,K0),MatRMM(K0,NnbMC0) 
   end   
   return 
end
