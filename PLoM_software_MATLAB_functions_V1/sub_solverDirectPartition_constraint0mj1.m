function  [MatReta_arj] = sub_solverDirectPartition_constraint0mj1(mj,n_d,nbMC,n_ar,nbmDMAPj,M0transient,Deltarj,f0j,shssj,shj, ...
   ...
   if mj ~= 1
      error('STOP in sub_solverDirectPartition_constraint0mj1; mj should be equal to 1')
   end
