function [MatRLrond] = sub_solverDirect_Lrond_constraint1(nu,n_d,MatReta_d,MatRa,MatRg,MatRZ,shss,sh,Rlambda_iter)
    ...
    %      Rlambda_iter(mhc,1) = ( lambda_1,...,lambda_nu)
    %
    %--- OUTPUTS
    ...
    for ell=1:n_d
        ...
        MatRLc(:,ell) = - 2*Rlambda_iter.*RU;                % MatRLc(nu,n_d), Rlambda_iter(nu,1), RU(nu,1)
    end
