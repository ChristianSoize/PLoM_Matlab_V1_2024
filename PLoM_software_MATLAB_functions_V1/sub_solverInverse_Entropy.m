function [entropy] = sub_solverInverse_Entropy(MatRx,ind_parallel)
   ...
   %--- Check data
   if n <= 0 || N <= 0
      error('STOP in sub_solverInverse_Entropy:  n <= 0 or N <= 0');
   end
...
% N     = 10000;
% MatRx = randn(n,N);
% [entropy] = sub_solverInverse_Entropy(MatRx,ind_parallel);
