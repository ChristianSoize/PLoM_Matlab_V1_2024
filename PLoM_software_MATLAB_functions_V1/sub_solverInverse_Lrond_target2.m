function [MatRLrond] = sub_solverInverse_Lrond_target2(nu,n_d,MatReta_d,MatRa,MatRg,MatRZ,shss,sh,Rlambda_iter)
    ...
    for ell = 1:n_d
        ...
        MatRLc(:,ell) = - Rlambda_iter;                      % MatRLc(nu,n_d), Rlambda_iter(nu,1)
    end
