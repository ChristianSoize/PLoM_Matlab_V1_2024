function [iX] = sub_solverInverse_Mutual_Information(MatRx,ind_parallel)
   ...
   %--- Check data
   if n <= 0 || N <= 0
      error('STOP in sub_solverInverse_Mutual_Information:  n <= 0 or N <= 0');
   end
...
% [iX] = sub_solverInverse_Mutual_Information(MatRx,ind_parallel)
